...
def from_json(obj: Mapping[str, Any]) -> UpdateChannelPerCommitmentPointInput:
    return UpdateChannelPerCommitmentPointInput(
        ...
        per_commitment_point=obj["update_channel_per_commitment_point_input_per_commitment_point"],
        per_commitment_point_index=obj["update_channel_per_commitment_point_input_per_commitment_point_index"],
