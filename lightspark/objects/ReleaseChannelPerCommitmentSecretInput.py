...
def from_json(obj: Mapping[str, Any]) -> ReleaseChannelPerCommitmentSecretInput:
    return ReleaseChannelPerCommitmentSecretInput(
        ...
        per_commitment_secret=obj["release_channel_per_commitment_secret_input_per_commitment_secret"],
        per_commitment_index=obj["release_channel_per_commitment_secret_input_per_commitment_index"],
