...
from .OutgoingPaymentAttempt import \
...
class OutgoingPaymentToAttemptsConnection(Connection):
    ...
    def to_json(self) -> Mapping[str, Any]:
        return {
            ...
            "outgoing_payment_to_attempts_connection_entities": [e.to_json() for e in self.entities],
...
def from_json(requester: Requester, obj: Mapping[str, Any]) -> OutgoingPaymentToAttemptsConnection:
    return OutgoingPaymentToAttemptsConnection(
        ...
        page_info=PageInfo_from_json(requester, obj["outgoing_payment_to_attempts_connection_page_info"]),
        entities=list(map(
 # pylint: disable=unnecessary-lambda 
 lambda e: OutgoingPaymentAttempt_from_json(requester, e), obj["outgoing_payment_to_attempts_connection_entities"])),
