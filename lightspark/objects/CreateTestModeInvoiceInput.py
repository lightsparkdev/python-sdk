...
class CreateTestModeInvoiceInput():
    ...
    def to_json(self) -> Mapping[str, Any]:
        return {
            ...
            "create_test_mode_invoice_input_invoice_type": self.invoice_type.value if self.invoice_type else None,
...
def from_json(obj: Mapping[str, Any]) -> CreateTestModeInvoiceInput:
    return CreateTestModeInvoiceInput(
        ...
        invoice_type=parse_enum_optional(InvoiceType, obj['create_test_mode_invoice_input_invoice_type']),
