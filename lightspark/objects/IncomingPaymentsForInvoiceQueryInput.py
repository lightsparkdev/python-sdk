...
class IncomingPaymentsForInvoiceQueryInput():
    ...
    def to_json(self) -> Mapping[str, Any]:
        return {
            ...
            "incoming_payments_for_invoice_query_input_statuses": [e.value for e in self.statuses] if self.statuses else None,
...
def from_json(obj: Mapping[str, Any]) -> IncomingPaymentsForInvoiceQueryInput:
    return IncomingPaymentsForInvoiceQueryInput(
        ...
        statuses=parse_optional_list_of_enums(TransactionStatus, obj["incoming_payments_for_invoice_query_input_statuses"]),
