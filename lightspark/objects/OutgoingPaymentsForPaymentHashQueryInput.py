...
class OutgoingPaymentsForPaymentHashQueryInput():
    ...
    def to_json(self) -> Mapping[str, Any]:
        return {
            ...
            "outgoing_payments_for_payment_hash_query_input_statuses": [e.value for e in self.statuses] if self.statuses else None,
...
def from_json(obj: Mapping[str, Any]) -> OutgoingPaymentsForPaymentHashQueryInput:
    return OutgoingPaymentsForPaymentHashQueryInput(
        ...
        statuses=parse_optional_list_of_enums(TransactionStatus, obj["outgoing_payments_for_payment_hash_query_input_statuses"]),
