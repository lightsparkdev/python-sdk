...
class PayTestModeInvoiceInput():
    ...
    def to_json(self) -> Mapping[str, Any]:
        return {
            ...
            "pay_test_mode_invoice_input_failure_reason": self.failure_reason.value if self.failure_reason else None,
...
def from_json(obj: Mapping[str, Any]) -> PayTestModeInvoiceInput:
    return PayTestModeInvoiceInput(
        ...
        failure_reason=parse_enum_optional(PaymentFailureReason, obj['pay_test_mode_invoice_input_failure_reason']),
